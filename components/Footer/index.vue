<template>
  <footer class="p-3 sm:py-6">
    <div class="sm:mx-auto sm:max-w-screen-xl md:flex md:justify-between">
      <div class="mb-6 md:mb-0">
        <UILogo class="hidden dark:text-white md:block" />
      </div>
      <div class="grid grid-cols-2 gap-8 sm:grid-cols-3 sm:gap-6">
        <div>
          <h2
            class="mb-6 text-sm font-semibold uppercase text-gray-900 dark:text-slate-100"
          >
            Resources
          </h2>
    ...
    <hr
      class="my-6 border-gray-700 dark:border-gray-200 sm:mx-auto sm:max-w-screen-xl lg:my-8"
    />
    <div
    ...
    >
      ...
      <div class="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
        <a
          href="https://www.facebook.com/kyngcytro/"
          class="text-gray-500 hover:text-gray-900 dark:hover:text-white"
        >
          <svg
            class="hover:fill-text-gray-900 h-5 w-5 fill-gray-500 dark:fill-slate-300"
            fill="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true"
          >
        ...
        <a
          href="http://github.com/kyng-cytro"
          class="text-gray-500 hover:text-gray-900 dark:hover:text-white"
        >
          <svg
            class="hover:fill-text-gray-900 h-5 w-5 fill-gray-500 dark:fill-slate-300"
